...
env.read_env(os.path.join(BASE_DIR, '../env/django.env'))
...
# URL show on broser.
# If changing MEDIA_URL, need to change url in instagram/views.py and instagram/react/src/context/appContext.js, 
